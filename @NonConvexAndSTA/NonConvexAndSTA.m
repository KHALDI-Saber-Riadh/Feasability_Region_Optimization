classdef NonConvexAndSTA < FeasibilityDrivenBase & handle
    ...
    methods (Access = public) 
        ...
        function obj = NonConvexAndSTA(input)
            ...
            obj.d_zxf = obj.input.scheme_parameters.d_zxf;
            obj.d_zxb = obj.input.scheme_parameters.d_zxb;
            obj.d_zy = obj.input.scheme_parameters.d_zy;
           ...
           for i = 1 : input.kar.number_of_subregions
               ...
               if obj.index <= obj.input.footstep_plan.ds_samples
                   ...
                   x_u_m = (obj.x_f_minus_one - obj.x_f_0) * exp(obj.eta * obj.T_ss_0) * obj.Delta_lambda / (obj.eta * obj.T_ds_0) ...
                           ...
                           - obj.d_zxb * (1 - exp(-obj.eta * obj.T_c)) + obj.x_f_minus_one + (obj.kinematic_buffer_x_m) * exp( - obj.eta * obj.T_p) ...
                           - obj.x_f_0 * exp( - obj.eta * obj.T_c) ...
                           + obj.tail_x - state.w_bar(1,1) / obj.eta ^ 2;
                   x_u_M = (obj.x_f_minus_one - obj.x_f_0) * exp(obj.eta * obj.T_ss_0) * obj.Delta_lambda / (obj.eta * obj.T_ds_0) ...
                           + obj.kinematic_and_temporal_buffer_x_M * obj.Delta_lambda + (obj.x_f_0 - obj.x_f_minus_one) * log(obj.Delta_lambda) / (obj.eta * obj.T_ds_0) ...        
                           + (obj.x_f_0 - obj.x_f_minus_one) * (1 + obj.eta * obj.T_s_0) / (obj.eta * obj.T_ds_0) ...
                           + obj.d_zxf * (1 - exp(-obj.eta * obj.T_c))  + obj.x_f_minus_one + (obj.kinematic_buffer_x_M) * exp( - obj.eta * obj.T_p) ...
                           - obj.x_f_0 * exp( - obj.eta * obj.T_c) ...
                           + obj.tail_x - state.w_bar(1,1) / obj.eta ^ 2;  
                   y_u_m = (obj.y_f_minus_one - obj.y_f_0) * exp(obj.eta * obj.T_ss_0) * obj.Delta_lambda / (obj.eta * obj.T_ds_0) ...
                           ...
                           - obj.d_zy * (1 - exp(-obj.eta * obj.T_c)) / 2 + obj.y_f_minus_one + (obj.kinematic_buffer_y_m) * exp( - obj.eta * obj.T_p) ...
                   ...
                   x_u_m = + obj.kinematic_and_temporal_buffer_x_m * obj.Delta_lambda ...
                           + (obj.x_f_minus_one - obj.d_zxb ) * (1 - exp( - obj.eta * obj.T_c)) ...
                           + obj.kinematic_buffer_x_m * exp( - obj.eta * obj.T_p) ...
                           + obj.tail_x - state.w_bar(1,1) / obj.eta ^ 2;
                   x_u_M = + obj.kinematic_and_temporal_buffer_x_M * obj.Delta_lambda ...
                           + (obj.x_f_minus_one + obj.d_zxf ) * (1 - exp( - obj.eta * obj.T_c)) ...
                           + obj.kinematic_buffer_x_M * exp( - obj.eta * obj.T_p) ...
                           + obj.tail_x - state.w_bar(1,1) / obj.eta ^ 2;
                   y_u_m = + obj.kinematic_and_temporal_buffer_y_m * obj.Delta_lambda ...
                           + (obj.y_f_minus_one - obj.d_zy / 2) * (1 - exp( - obj.eta * obj.T_c)) ...
                   ...
                   if i == 1
                       ...
                       obj.linear_feasibility_region.b_x_m = (obj.x_f_minus_one - obj.d_zxb ) * (1 - exp( - obj.eta * obj.T_c)) + obj.kinematic_buffer_x_m * exp( - obj.eta * obj.T_p) + obj.tail_x - state.w_bar(1,1) / obj.eta ^ 2;
                       obj.linear_feasibility_region.a_x_M = obj.kinematic_and_temporal_buffer_x_M;
                       obj.linear_feasibility_region.b_x_M = (obj.x_f_minus_one + obj.d_zxf ) * (1 - exp( - obj.eta * obj.T_c)) + obj.kinematic_buffer_x_M * exp( - obj.eta * obj.T_p) + obj.tail_x - state.w_bar(1,1) / obj.eta ^ 2;
                       obj.linear_feasibility_region.a_y_m = obj.kinematic_and_temporal_buffer_y_m;
                       obj.linear_feasibility_region.b_y_m = (obj.y_f_minus_one - obj.d_zy / 2) * (1 - exp( - obj.eta * obj.T_c)) + obj.kinematic_buffer_y_m * exp( - obj.eta * obj.T_p) + obj.tail_y - state.w_bar(2,1) / obj.eta ^ 2;
                       obj.linear_feasibility_region.a_y_M = obj.kinematic_and_temporal_buffer_y_M;
                       obj.linear_feasibility_region.b_y_M = (obj.y_f_minus_one + obj.d_zy / 2) * (1 - exp( - obj.eta * obj.T_c)) + obj.kinematic_buffer_y_M * exp( - obj.eta * obj.T_p) + obj.tail_y - state.w_bar(2,1) / obj.eta ^ 2;
                   end
