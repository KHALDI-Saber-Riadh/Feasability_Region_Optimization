classdef RecoveryMode < FeasibilityDrivenBase & handle
    ...
    methods (Access = public)
        ...
        function obj = RecoveryMode(input)
            ...
            obj.A_zmp_constr_toe(1 : obj.input.scheme_parameters.C, 1 : obj.input.scheme_parameters.C) = obj.P_matrix;
            obj.A_zmp_constr_toe(obj.input.scheme_parameters.C + 1 : 2 * obj.input.scheme_parameters.C, 1 : obj.input.scheme_parameters.C) = - obj.P_matrix;
        ...
        function [u, ftstp] = solve(obj, state, input)
            ...
            obj.A_zmp_constr_toe(1 : obj.input.scheme_parameters.C, obj.input.scheme_parameters.C + 1 : obj.input.scheme_parameters.C + obj.input.scheme_parameters.M) = - obj.input.footstep_plan.mapping(:, 2 : obj.input.scheme_parameters.M + 1);
            obj.A_zmp_constr_toe(obj.input.scheme_parameters.C + 1 : 2 * obj.input.scheme_parameters.C, obj.input.scheme_parameters.C + 1 : obj.input.scheme_parameters.C + obj.input.scheme_parameters.M) =  obj.input.footstep_plan.mapping(:, 2 : obj.input.scheme_parameters.M + 1);
